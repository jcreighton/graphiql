...
var ToolbarSelect = (function (_super) {
  ...
  ToolbarSelect.prototype.render = function () {
    ...
    var optionChildren = React.Children.map(this.props.children, function (
      child,
      i,
    ) {
      if (!hasProps(child)) {
      ...
      return React.createElement(
        ToolbarSelectOption,
        __assign({}, child.props, { onSelect: onChildSelect }),
      );
    });
    return React.createElement(
      'a',
      ...
      selectedChild === null || selectedChild === void 0
        ? void 0
    ...
    selected &&
      React.createElement(
        ...
        React.createElement('polygon', {
          points:
            '4.851,10.462 0,5.611 2.314,3.297 4.851,5.835\n    10.686,0 13,2.314 4.851,10.462',
        }),
      ),
  );
}
