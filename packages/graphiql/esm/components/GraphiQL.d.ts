...
export declare class GraphiQL extends React.Component<
  GraphiQLProps,
  GraphiQLState
> {
...
declare function GraphiQLLogo<TProps>(
  props: PropsWithChildren<TProps>,
): JSX.Element;
declare namespace GraphiQLLogo {
  var displayName: string;
}
declare function GraphiQLToolbar<TProps>(
  props: PropsWithChildren<TProps>,
): JSX.Element;
declare namespace GraphiQLToolbar {
  var displayName: string;
}
declare function GraphiQLFooter<TProps>(
  props: PropsWithChildren<TProps>,
): JSX.Element;
