...
var ExecuteButton = (function (_super) {
      ...
      var onMouseUp = function (upEvent) {
        ...
        if (initialPress && upEvent.target === downTarget) {
          ...
          var isOptionsMenuClicked =
            ...
            ((_a = downTarget.parentNode) === null || _a === void 0
              ? void 0
              : _a.compareDocumentPosition(upEvent.currentTarget)) &&
  ...
  ExecuteButton.prototype.render = function () {
    ...
    var pathJSX = this.props.isRunning
      ? React.createElement('path', { d: 'M 10 10 L 23 10 L 23 23 L 10 23 z' })
      : React.createElement('path', { d: 'M 11 9 L 24 16 L 11 23 z' });
    return React.createElement(
      'div',
