  ...
  TypeDoc.prototype.render = function () {
    ...
    if ('getFields' in type) {
      ...
      if (deprecatedFields.length > 0) {
        deprecatedFieldsDef = React.createElement(
          'div',
          { className: 'doc-category' },
          React.createElement(
            'div',
    ...
    if (type instanceof GraphQLEnumType) {
      ...
      valuesDef = React.createElement(
        ...
        values
          ...
          .map(function (value) {
            return React.createElement(EnumValue, {
              key: value.name,
              value: value,
            });
          }),
      ...
      if (deprecatedValues.length > 0) {
        deprecatedValuesDef = React.createElement(
          'div',
          { className: 'doc-category' },
          React.createElement(
            'div',
