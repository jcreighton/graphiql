...
function FieldDoc(_a) {
  ...
  if (field && 'args' in field && field.args.length > 0) {
    argsDef = react_1.default.createElement(
      'div',
      ...
      field.args.map(function (arg) {
        return react_1.default.createElement(
          ...
          react_1.default.createElement(
            'div',
            null,
            react_1.default.createElement(Argument_1.default, {
              arg: arg,
              onClickType: onClickType,
            }),
          ),
          react_1.default.createElement(MarkdownContent_1.default, {
  ...
  if (
    ...
    directivesDef = react_1.default.createElement(
      'div',
      { className: 'doc-category' },
      react_1.default.createElement(
        'div',
      ...
      field.astNode.directives.map(function (directive) {
        return react_1.default.createElement(
          'div',
          { key: directive.name.value, className: 'doc-category-item' },
          react_1.default.createElement(
            'div',
            null,
            react_1.default.createElement(Directive_1.default, {
              directive: directive,
            }),
          ),
        );
  ...
  return react_1.default.createElement(
    ...
    react_1.default.createElement(MarkdownContent_1.default, {
      ...
      markdown:
        (field === null || field === void 0 ? void 0 : field.description) ||
        'No Description',
    }),
    field &&
      ...
      react_1.default.createElement(MarkdownContent_1.default, {
        ...
        markdown:
          field === null || field === void 0 ? void 0 : field.deprecationReason,
      }),
    react_1.default.createElement(
      'div',
      { className: 'doc-category' },
      ...
      react_1.default.createElement(TypeLink_1.default, {
