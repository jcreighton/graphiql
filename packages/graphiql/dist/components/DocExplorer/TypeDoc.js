...
var TypeDoc = (function (_super) {
  ...
  TypeDoc.prototype.render = function () {
    ...
    if (types && types.length > 0) {
      typesDef = react_1.default.createElement(
        'div',
    ...
    if ('getFields' in type) {
      ...
      fieldsDef = react_1.default.createElement(
        'div',
        { className: 'doc-category' },
        react_1.default.createElement(
          'div',
        ...
        fields
          ...
          .map(function (field) {
            return react_1.default.createElement(Field, {
              key: field.name,
              type: type,
              field: field,
      ...
      if (deprecatedFields.length > 0) {
        deprecatedFieldsDef = react_1.default.createElement(
          'div',
          { className: 'doc-category' },
          react_1.default.createElement(
            'div',
    ...
    if (type instanceof graphql_1.GraphQLEnumType) {
      ...
      valuesDef = react_1.default.createElement(
        'div',
        { className: 'doc-category' },
        react_1.default.createElement(
          'div',
        ...
        values
          ...
          .map(function (value) {
            return react_1.default.createElement(EnumValue, {
              key: value.name,
              value: value,
            });
          }),
      ...
      if (deprecatedValues.length > 0) {
        deprecatedValuesDef = react_1.default.createElement(
          'div',
          { className: 'doc-category' },
          react_1.default.createElement(
            'div',
      ...
      field.args.length > 0 && [
        ...
        react_1.default.createElement(
          ...
          field.args.map(function (arg) {
            return react_1.default.createElement(Argument_1.default, {
              key: arg.name,
              arg: arg,
              onClickType: onClickType,
            });
