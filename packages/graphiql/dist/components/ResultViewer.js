...
var ResultViewer = (function (_super) {
  ...
  ResultViewer.prototype.componentDidMount = function () {
    ...
    if (Tooltip || ImagePreview) {
      ...
      CodeMirror.registerHelper('info', 'graphql-results', function (
        token,
        _options,
        _cm,
        pos,
        ...
        if (Tooltip) {
          infoElements.push(
            react_1.default.createElement(Tooltip, { pos: pos }),
          );
        }
        if (
          ImagePreview &&
          ...
          infoElements.push(
            react_1.default.createElement(ImagePreview, { token: token }),
          );
        }
        ...
        react_dom_1.default.render(
          react_1.default.createElement('div', null, infoElements),
          tooltipDiv_1,
        );
        return tooltipDiv_1;
      });
