...
export declare class ToolbarSelect extends React.Component<
  ToolbarSelectProps,
  ToolbarSelectState
> {
  private _node;
  ...
  handleOpen: (e: React.MouseEvent<Element, MouseEvent>) => void;
}
...
export declare function ToolbarSelectOption({
  onSelect,
  label,
  selected,
