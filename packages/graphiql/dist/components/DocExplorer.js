...
var DocExplorer = (function (_super) {
  ...
  DocExplorer.prototype.shouldComponentUpdate = function (
    nextProps,
    nextState,
  ) {
    return (
  ...
  DocExplorer.prototype.render = function () {
    ...
    if (schema === undefined) {
      ...
      content = react_1.default.createElement(SearchResults_1.default, {
      ...
      content = react_1.default.createElement(SchemaDoc_1.default, {
        schema: schema,
        onClickType: this.handleClickType,
      });
    } else if (graphql_1.isType(navItem.def)) {
      content = react_1.default.createElement(TypeDoc_1.default, {
        schema: schema,
        type: navItem.def,
        onClickType: this.handleClickType,
        onClickField: this.handleClickField,
      ...
      content = react_1.default.createElement(FieldDoc_1.default, {
        field: navItem.def,
        onClickType: this.handleClickType,
      });
    }
    ...
    return react_1.default.createElement(
      ...
      react_1.default.createElement(
        ...
        shouldSearchBoxAppear &&
          react_1.default.createElement(SearchBox_1.default, {
  ...
  DocExplorer.prototype.showSearch = function (search) {
    ...
    var topNav = navStack[navStack.length - 1];
    navStack[navStack.length - 1] = __assign(__assign({}, topNav), {
      search: search,
    });
