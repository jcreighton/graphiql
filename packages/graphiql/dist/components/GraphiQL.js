...
var getSelectedOperationName_1 = __importDefault(
...
var GraphiQL = (function (_super) {
  ...
  function GraphiQL(props) {
    ...
    _this.handlePrettifyQuery = function () {
      ...
      var editorContent =
        (_a =
          ...
          ? _a
          : '';
      var prettifiedEditorContent = graphql_1.print(
        graphql_1.parse(editorContent),
      );
    ...
    _this.handleMergeQuery = function () {
      ...
      editor.setValue(
        graphql_1.print(mergeAst_1.default(ast, _this.state.schema)),
      );
    };
    ...
    _this._updateQueryFacts = function (
      ...
      if (queryFacts) {
        var updatedOperationName = getSelectedOperationName_1.default(
          prevOperations,
          operationName,
    ...
    _this.handleResizeStart = function (downEvent) {
      ...
      var offset =
        downEvent.clientX - elementPosition_1.getLeft(downEvent.target);
      var onMouseMove = function (moveEvent) {
        ...
        var leftSize =
          moveEvent.clientX - elementPosition_1.getLeft(editorBar) - offset;
    ...
    _this.handleDocsResizeStart = function (downEvent) {
      ...
      var onMouseMove = function (moveEvent) {
        ...
        var cursorPos =
          moveEvent.clientX - elementPosition_1.getLeft(app) - offset;
    ...
    _this.handleSecondaryEditorResizeStart = function (downEvent) {
      ...
      var offset =
        downEvent.clientY - elementPosition_1.getTop(downEvent.target);
      var onMouseMove = function (moveEvent) {
        if (moveEvent.buttons === 0) {
          return onMouseUp();
        }
        ...
        var editorBar = _this.editorBarComponent;
        var topSize =
          moveEvent.clientY - elementPosition_1.getTop(editorBar) - offset;
    ...
    var operationName =
      props.operationName !== undefined
        ? props.operationName
        : getSelectedOperationName_1.default(
            undefined,
  ...
  GraphiQL.prototype.render = function () {
    ...
    var logo =
      find_1.default(children, function (child) {
    ...
    var toolbar =
      ...
      react_1.default.createElement(
        GraphiQL.Toolbar,
        null,
        react_1.default.createElement(ToolbarButton_1.ToolbarButton, {
    ...
    return react_1.default.createElement(
      react_1.Fragment,
      null,
      react_1.default.createElement('div', null, 'THIS IS WORKING'),
      react_1.default.createElement(
        'div',
        {
          ref: function (n) {
        ...
        react_1.default.createElement(
          ...
          react_1.default.createElement(
            ...
            react_1.default.createElement(
              ...
              { className: 'topBar' },
              logo,
              react_1.default.createElement(ExecuteButton_1.ExecuteButton, {
          ...
          react_1.default.createElement(
            ...
            react_1.default.createElement(
              ...
              react_1.default.createElement(QueryEditor_1.QueryEditor, {
                ref: function (n) {
              ...
              react_1.default.createElement(
                ...
                react_1.default.createElement(VariableEditor_1.VariableEditor, {
                  ref: function (n) {
                ...
                this.state.headerEditorEnabled &&
                  react_1.default.createElement(HeaderEditor_1.HeaderEditor, {
                    ref: function (n) {
            ...
            react_1.default.createElement(
              ...
              react_1.default.createElement(ResultViewer_1.ResultViewer, {
                ...
                ImagePreview: ImagePreview_1.ImagePreview,
              }),
              footer,
            ),
          ),
