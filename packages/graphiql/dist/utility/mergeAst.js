  ...
  for (var _i = 0, array_1 = array; _i < array_1.length; _i++) {
    ...
    if (item.kind === 'Field') {
      ...
      if (item.directives && item.directives.length) {
        ...
        existing.selectionSet.selections = __spreadArrays(
  ...
  for (var _i = 0, selections_1 = selections; _i < selections_1.length; _i++) {
    ...
    if (
      ...
      (!selection.directives ||
        ((_a = selection.directives) === null || _a === void 0
          ? void 0
          : _a.length) === 0)
    ) {
...
function mergeAST(documentAST, schema) {
  ...
  return graphql_1.visit(
    documentAST,
    typeInfo ? graphql_1.visitWithTypeInfo(typeInfo, visitors) : visitors,
  );
}
